...
public class BinaryTreeTest {
    ...
    */
    ...
    public void InsertTest() {
        ...
        System.out.println(binarySearchTree.right.payload);
        System.out.println(binarySearchTree.right.right.payload);
        System.out.println(binarySearchTree.right.right.right.payload);
        System.out.println(binarySearchTree.right.right.right.right.payload);
        System.out.println(expectedInsert.payload);
